...
func (a Analyzer) convertValue(zctx *Context, val zed.Value, parent zed.Type) (Value, error) {
	switch val := val.(type) {
...
func (a Analyzer) convertAny(zctx *Context, val zed.Any, cast zed.Type) (Value, error) {
...
func (a Analyzer) convertPrimitive(zctx *Context, val *zed.Primitive, cast zed.Type) (Value, error) {
...
func stringToEnum(val *zed.Primitive, cast zed.Type) Value {
...
func (a Analyzer) convertRecord(zctx *Context, val *zed.Record, cast zed.Type) (Value, error) {
	var fields []Value
	var err error
	if cast != nil {
...
func (a Analyzer) convertFields(zctx *Context, in []zed.Field, cols []zed.Column) ([]Value, error) {
...
func lookupRecordType(zctx *Context, fields []zed.Field, vals []Value) (*zed.TypeRecord, error) {
...
func (a Analyzer) convertArray(zctx *Context, array *zed.Array, cast zed.Type) (Value, error) {
...
func (a Analyzer) convertSet(zctx *Context, set *zed.Set, cast zed.Type) (Value, error) {
...
func (a Analyzer) convertEnum(zctx *Context, val *zed.Enum, cast zed.Type) (Value, error) {
	if cast == nil {
...
func (a Analyzer) convertMap(zctx *Context, m *zed.Map, cast zed.Type) (Value, error) {
...
func (a Analyzer) convertTypeValue(zctx *Context, tv *zed.TypeValue, cast zed.Type) (Value, error) {
	if cast != nil {
...
func (a Analyzer) convertType(zctx *Context, typ zed.Type) (zed.Type, error) {
	switch t := typ.(type) {
...
func (a Analyzer) convertTypeRecord(zctx *Context, typ *zed.TypeRecord) (*zed.TypeRecord, error) {
	fields := typ.Fields
	columns := make([]zed.Column, 0, len(fields))
...
func (a Analyzer) convertTypeMap(zctx *Context, tmap *zed.TypeMap) (*zed.TypeMap, error) {
...
func (a Analyzer) convertTypeUnion(zctx *Context, union *zed.TypeUnion) (*zed.TypeUnion, error) {
	var types []zed.Type
...
func (a Analyzer) convertTypeEnum(zctx *Context, enum *zed.TypeEnum) (*zed.TypeEnum, error) {
